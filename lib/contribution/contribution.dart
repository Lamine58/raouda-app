...
class Contribution extends StatefulWidget {
  ...
  Contribution(this.contribution,this.contribution_id,this.customer_id,{Key? key}) : super(key: key);
...
class _ContributionState extends State<Contribution> {
  ...
  Future<void> _loadData() async {
    ...
    if (!_isLoading && next_page_url!=null) {
      ...
      try {
        ...
        response = await api.url(next_page_url+'&customer_id='+widget.customer_id+'&contribution_id='+widget.contribution_id);
  ...
  data() async {
    ...
    var response = await api.get('payments?customer_id='+widget.customer_id+'&contribution_id='+widget.contribution_id);
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Payment(widget.contribution,widget.customer_id,widget.contribution_id),
                      ),
                    );
                  },
