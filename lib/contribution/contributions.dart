...
import 'package:raouda_collecte/contribution/contribution.dart';
...
class Contributions extends StatefulWidget {
  final dynamic id;
  const Contributions(this.id,{Key? key}) : super(key: key);
...
class _ContributionsState extends State<Contributions> {
  ...
  data() async {
    ...
    var response = await api.get('contributions?id='+widget.id);
                        ...
                        return Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => Contribution(item,item['pivot']['contribution_id'],item['pivot']['customer_id']))
                              );
                            },
                            child: Container(
