...
import 'package:raouda_collecte/saving/saving.dart';
...
class Savings extends StatefulWidget {
  final dynamic id;
  const Savings(this.id,{Key? key}) : super(key: key);
...
class _SavingsState extends State<Savings> {
  ...
  data() async {
    ...
    var response = await api.get('savings?id='+widget.id);
                        ...
                        return Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => Saving(item,item['pivot']['saving_id'],item['pivot']['customer_id']))
                              );
                            },
                            child: Container(
